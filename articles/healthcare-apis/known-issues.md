...
| :------------------------------------- | :------------ | :------------- | :------------- |
|API calls to FHIR service in UK South region were failing with Internal server error (HTTP Status code:500)|August 2023 9:53 am PST|--|August 2023 10:43 am PST|
